...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", default=300, help="the epochs of training")
    parser.add_argument("--use_gpu", default=False, help="device choice, if cuda isn't available program will warn")
